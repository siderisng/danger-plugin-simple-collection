...
export const jiraKeyError = '===== No JIRA key specified. This is required. ======'
export const jiraUrlError = '===== No JIRA workspace url specified. This is required. ====='
...
export default function simpleCollection({
  ...
  if (!disabled.jiraIssue) jiraIssue({
      key: jiraKey,
      url: jiraUrl,
      emoji: ':paperclip:',
